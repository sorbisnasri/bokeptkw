...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokeptkw.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'LGjJk5EDu6l1YJgK5HZhTGM3GRkgycF-nCREUlqCsw8',
        yandex: '6788caf4a631017f',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat pelajar.`,
        "logo": "https://bokeptkw.pages.dev/favicon.ico",
        "url": "https://bokeptkw.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokeptkw.pages.dev"
        ...
        "url": "https://bokeptkw.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat pelajar.`,
        "image": "https://bokeptkw.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokeptkw.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokeptkw.pages.dev/?q={search_term}", 
